					...
					<div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
						...
						<c:forEach var="product02" items="${list02}">
							<div class="col">
								<div class="product-item">
									<figure>
										<a href="index.html" title="Product Title"> <img src="${pageContext.request.contextPath}/resources/img/${product02.thumbnail_img}" alt="Product Thumbnail" class="tab-image" />
										</a>
									</figure>
									<div class="d-flex flex-column text-center">
					...
					<div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
						...
						<c:forEach var="product03" items="${list03}">
							<div class="col">
								<div class="product-item">
									<figure>
										<a href="index.html" title="Product Title"> <img src="${pageContext.request.contextPath}/resources/img/${product03.thumbnail_img}" alt="Product Thumbnail" class="tab-image" />
										</a>
									</figure>
									<div class="d-flex flex-column text-center">
					...
					<div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
						...
						<c:forEach var="product04" items="${list04}">
							<div class="col">
								<div class="product-item">
									<figure>
										<a href="index.html" title="Product Title"> <img src="${pageContext.request.contextPath}/resources/img/${product04.thumbnail_img}" alt="Product Thumbnail" class="tab-image" />
										</a>
									</figure>
									<div class="d-flex flex-column text-center">
